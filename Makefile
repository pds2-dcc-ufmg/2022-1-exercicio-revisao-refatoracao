...
$(BUILD_DIR)/main.o: $(BUILD_DIR)/Alimentacao.o $(BUILD_DIR)/Animal.o $(BUILD_DIR)/Cuidador.o $(BUILD_DIR)/Herpestidae.o $(BUILD_DIR)/Ursidae.o $(SRC_DIR)/main.cpp
...
open:
	code -r $(INCLUDE_DIR)/* $(SRC_DIR)/entidades/*
