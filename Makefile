...
${TARGET}: ${BUILD_DIR}/Animal.o ${BUILD_DIR}/Herpestidae.o ${BUILD_DIR}/Ursidae.o ${BUILD_DIR}/Cuidador.o ${BUILD_DIR}/Alimentacao.o ${BUILD_DIR}/main.o
...
${BUILD_DIR}/Alimentacao.o: ${INCLUDE_DIR}/Alimentacao.hpp ${SRC_DIR}/objects/Cuidador.cpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR}/ -c ${SRC_DIR}/objects/Alimentacao.cpp -o ${BUILD_DIR}/Alimentacao.o

${BUILD_DIR}/main.o: ${INCLUDE_DIR}/Herpestidae.hpp ${INCLUDE_DIR}/Ursidae.hpp ${INCLUDE_DIR}/Cuidador.hpp ${SRC_DIR}/main.cpp
