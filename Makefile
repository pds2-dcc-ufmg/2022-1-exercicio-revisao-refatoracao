./vpl_execution: build/main.o build/Herpestidae.o build/Ursidae.o build/Animal.o build/Cuidador.o build/Alimentacao.o
	g++ build/main.o build/Herpestidae.o build/Ursidae.o build/Animal.o build/Cuidador.o build/Alimentacao.o -o ./vpl_execution
...
build/Alimentacao.o: src/entidades/Alimentacao.cpp
	g++ -c src/entidades/Alimentacao.cpp -I include/ -o build/Alimentacao.o
