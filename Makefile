...
SRC_DIR	= ./src
INCLUDE_DIR	= ./include
${BUILD_DIR}/${TARGET}: ${BUILD_DIR}/Animal.o ${BUILD_DIR}/Ursidae.o ${BUILD_DIR}/Herpestidae.o ${BUILD_DIR}/Cuidador.o ${BUILD_DIR}/Alimentacao.o ${BUILD_DIR}/main.o
	${CC} ${CFLAGS} ${BUILD_DIR}/*.o -o vpl_execution
