...
std::string Ursidae::getAtributo(std::string campo) {
...
void Ursidae::setAtributo(std::string campo, std::string valor) {
    if(campo == "nome") {
        this->nome = valor;
    } else if(campo == "idade") {
...
double Ursidae::peixesConsumidos(int porcoesConsumidas) {
