...
int main(){
  ...
  Ursidae* Bobby = new Ursidae("Bobby", 13);
  Bobby->print();

  Ursidae* Jorge = new Ursidae("Jorge", 1);
  Jorge->print();

  Herpestidae* Bonina = new Herpestidae("Bonina", 7);
  Bonina->print();

  Ursidae* Felicio = new Ursidae("Felicio", 3);
  Felicio->print();

  Ursidae* Tony = new Ursidae("Tony", 9);
  Tony->setEspecie("Urso Pardo");
  Tony->setkgPeixePorDia(10.5);
  Tony->print();
  
  Ursidae* Wanda = new Ursidae("Wanda", 10);
  Wanda->setEspecie("Urso Polar");
  Wanda->setkgPeixePorDia(7);
  Wanda->print();

  Herpestidae* Catita = new Herpestidae("Catita", 2);
  Catita->setEspecie("Suricato");
  Catita->print();

  Herpestidae* Carolina = new Herpestidae("Carolina", 2);
  Carolina->setEspecie("Suricato");
  Carolina->print();

  Cuidador* Ana = new Cuidador("Ana Maria Rodrigues Lopes", 123456779, "(31) 99876-6923", "10/10/2000", "R$ 3000");
  Ana->print();

  Cuidador* Fernanda = new Cuidador("Fernanda Silva Santos", 9472567121, "(31) 99123-8970", "08/02/1995", "R$ 4000");
  Fernanda->print();
